...
const EventAdjustCta = ({ offerItem, offerItemCartData, setOfferItemData, addToCart }) => {
    return (React.createElement("section", { className: styles_1.offerItemStyles.adjustCtaContainerCss },
        offerItem && !offerItem.title.includes('Free Trial') && (React.createElement("article", { className: "adjust-container" },
...
exports.default = EventAdjustCta;
