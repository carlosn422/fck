...
export const hotelOfferItem1: HotelOfferItem = {
  ...
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/4-1_thumbnail_room%402x.png',
  media:
...
export const hotelOfferItem2: HotelOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvr',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/4-2_thumbnail_room%402x.png',
  media:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/4-1-2_Hero_room%402x.png',
...
export const hotelOfferItem3: HotelOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvr',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/4-3_thumbnail_room%402x.png',
  media:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/4-2_Hero_room%402x.png',
...
export const hotelOfferItem4: HotelOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvr',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/4-4_thumbnail_room%402x.png',
  media:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/4-3_Hero_room%402x.png',
...
export const hotelOfferListItem1: HotelOfferListItem = {
  id: cuid(),
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/3-1_thumbnail_hotel%402x.png',
...
export const hotelOfferListItem2: HotelOfferListItem = {
  id: cuid(),
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/3-2_thumbnail_hotel%402x.png',
  ...
  items: [hotelOfferItem2, hotelOfferItem3, hotelOfferItem4]
}

export const hotelOfferListItem3: HotelOfferListItem = {
  id: cuid(),
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/3-3_thumbnail_hotel%402x.png',
  ...
  items: [hotelOfferItem3, hotelOfferItem4]
}
export const hotelOfferListItem4: HotelOfferListItem = {
  id: cuid(),
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/3-4_thumbnail_hotel%402x.png',
...
export const eventOfferItem: EventOfferItem = {
  ...
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/1-1_thumbnail_tickets%402.png',
...
const eventOfferItem5: EventOfferItem = {
...
export const eventOfferItemParent: EventOffer = {
  ...
  description: 'Most Popular',
  type: OfferItemType.Event,
  startDate: parse('2019-05-14', 'yyyy-MM-dd', new Date()).toJSON(),
...
export const hotelOfferItemParent: HotelOffer = {
  ...
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/1-2_thumbnail_hotels%402.png',
  title: 'Hotels',
...
export const offerItemMerch2: MerchOfferItem = {
  ...
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/5-2_thumbnail_merch%402x.png',
  title: 'ACL Flags Lineup Tank',
  description: '',
  startingPrice: 20,
  htmlDescription: merchCopy2,
  media:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/5-2_hero_merch%402x.png',
...
export const offerItemMerch: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/5-1_thumbnail_merch%402x.png',
...
export const offerItemMerch3: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/5-3_thumbnail_merch%402x.png',
  title: '2017 Yellow Rose Feedstore Hat',
  media:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/5-3_hero_merch%402x.png',
  description: '10 Left',
  startingPrice: 35,
  type: OfferItemType.Merch,
...
export const offerItemMerch4: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/5-4_thumbnail_merch%402x.png',
  media:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/5-4_hero_merch%402x.png',
...
export const offerPage: OfferPage = {
  ...
  backgroundImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/0_ACL_landing+page%402x.png',
  ...
  leaderboardImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/gif_ACL.gif',
  progressImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/reward+progress.svg',
  confirmationDetailsImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-acl/confirmation.svg',
