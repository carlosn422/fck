...
export const offerItemMerch: MerchOfferItem = {
  ...
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony/3_inventory.png',
...
export const offerItemMerch1: MerchOfferItem = {
  id: 'cjg8ckfis000j3i5nuye5py8z',
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony/pic+1.png',
  title: 'The Last Of Us™ Left Behind Again',
  description: '',
  media:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony/pic+1_Hero%402x.png',
...
export const merchOfferItemParent: MixedOffer = {
  ...
  uri: 'last-of-us',
  items: [offerItemMerch, offerItemMerch1]
}

export const offerPage: OfferPage = {
  id: guid(),
  brandColor: '#0f44af',
  offer: merchOfferItemParent,
  ...
  backgroundImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony/1_Home.png',
  leaderboardImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony/gif_Sony.gif',
  progressImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony/reward-progress.svg',
  confirmationDetailsImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony/gift.svg',
