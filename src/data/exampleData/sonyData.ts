...
export const offerItemMerch: MerchOfferItem = {
  ...
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony-2/01_inventory_thumbnail_01%402x.png',
  title: 'Days Gone',
  description: '',
...
export const merchOfferItemParent: MixedOffer = {
  ...
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony-2/01_inventory_thumbnail_02%402x.png',
  title: 'Days Gone',
...
export const offerPage: OfferPage = {
  ...
  backgroundImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony-2/00_Sony_daysgone_landing+page%401x.png',
  leaderboardImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony/gif_Sony.gif',
  progressImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony-2/sony_days+gone_reward+progress.svg',
  confirmationDetailsImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sony-2/sony_days+gone_confirmation%402x.png',
