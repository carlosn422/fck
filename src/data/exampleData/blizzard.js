...
const eventOfferItem11 = {
    ...
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/2_Overwatch%20League@2x.png',
    title: '200 Sections',
    description: '',
    startingPrice: 55,
...
const eventOfferItem21 = {
    ...
    parentId: 'cjftxsxt10001ho8e495ushvq',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/2_Call+of+duty+league%402x.png',
    title: 'GA',
    description: '',
    startingPrice: 65,
    type: offerTypes_1.OfferItemType.Event
...
const gameOfferItem31 = {
    id: 'cjyuhgn0700co66lsv29dtuom',
    parentId: 'cjftxsxt10001ho8e495ushvq',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/2_Games%402x.png',
    title: 'Sekiro Shadows Die Twice',
    description: '',
    startingPrice: 59.99,
    type: offerTypes_1.OfferItemType.Event
};
const gameOfferItem32 = {
    id: 'cjyuhgn0700cp66lsonvkope9',
    parentId: 'cjftxsxt10001ho8e495ushvq',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/3-games-cod.jpg',
...
const merchItem1 = {
    ...
    parentId: 'cjftxsxt10001ho8e495ushvq',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/3_Winston+Incredibuild%402x.png',
    media: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/3_Winston+Incredibuild%402x.png',
    title: 'Overwatch Winston Incredibuilds Wood Model',
    description: 'The IncrediBuilds Overwatch Winston Poster and 3D Wood Model Kit ',
    startingPrice: 22,
...
const merchItem2 = {
    ...
    parentId: 'cjftxsxt10001ho8e495ushvq',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/3_Pachimari%402x.png',
    media: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/3_Pachimari%402x.png',
    title: 'Overwatch Pachimari Pullover Hoodie',
    description: 'You’ll be well on your way to smiling as brightly as Pachimari with this soft, light blue hoodie',
    startingPrice: 45,
    type: offerTypes_1.OfferItemType.Merch,
    productDetails: {
        sizes: [
...
const merchItem3 = {
    ...
    parentId: 'cjftxsxt10001ho8e495ushvq',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/3_Hearthstone%402x.png',
    media: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/3_Hearthstone%402x.png',
    // prettier-ignore
...
exports.eventOfferItemParent = {
    ...
    items: [exports.eventOffer11, exports.eventOffer12]
};
exports.eventOfferItem2Parent = {
    id: cuid(),
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/2_Call+of+duty+league%402x.png',
    ...
    rewards: exports.eventRewards,
    // rewardCopy: 'Rewards available for bringing 10 friends',
    items: [exports.eventOffer2]
};
exports.gamesItemParent = {
    id: cuid(),
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/2_Games%402x.png',
    title: 'Games',
    ...
    // addonOffer: addonOfferParent,
    items: [exports.gameItem31, exports.gameItem32]
};
exports.merchItemParent = {
    id: cuid(),
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/2_Merchandise%402x.png',
    title: 'Merchandise',
    description: '',
    type: offerTypes_1.OfferItemType.Merch,
...
exports.offerPage = {
    ...
    backgroundImage: 'https://fevo-fuc.s3.amazonaws.com/assets-demo-blizzard/1_Activision_Landing+page+%402x.png',
