...
export const spaRewards: Reward[] = [
  {
    id: '1003',
...
export const nightLifeRewards: Reward[] = [
  {
    id: '1105',
...
export const smlHotelOfferItem: HotelOfferItem = {
  id: 'cjg8ckfiv000l3i5nnawuwwq6',
  parentId: 'cjg8ckfin000b3i5nqvliryz6',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/rooms/Room1_Super.png',
  title: 'Superior, King Bed',
  description: 'In high demand',
  startingPrice: 550,
  type: OfferItemType.Hotel
}
export const smlHotelOfferItem1: HotelOfferItem = {
  id: 'cjg8ckfiv000m3i5n4znpx91o',
  parentId: 'cjg8ckfin000b3i5nqvliryz6',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/rooms/Room2_Premier.png',
  title: 'Premier, King Bed ',
  description: '10 people are looking at this right now',
  startingPrice: 588,
  type: OfferItemType.Hotel
}
export const smlHotelOfferItem2: HotelOfferItem = {
  id: 'cjg8ckfis000i3i5nittntgbj',
  parentId: 'cjg8ckfin000b3i5nqvliryz6',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/rooms/Room3_Studio.png',
...
export const smlHotelOfferItem3: HotelOfferItem = {
  id: 'cjg8ckfis000i3i5nittntgbx',
  parentId: 'cjg8ckfin000b3i5nqvliryz6',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/rooms/Room4_Terrace.png',
...
export const hotelOfferListItem1: HotelOfferListItem = {
  id: guid(),
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/hotels/Hotel_1_BH.png',
  title: 'Beverly Hills',
  description: '',
...
export const hotelOfferListItem2: HotelOfferListItem = {
  ...
  details: roomCopy,
  uri: 'South-Beach',
  items: [smlHotelOfferItem, smlHotelOfferItem1, smlHotelOfferItem2]
}

export const hotelOfferListItem3: HotelOfferListItem = {
  id: guid(),
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/hotels/Hotel_3_LV.png',
  title: 'Las Vegas',
  description: '',
...
export const hotelOfferListItem4: HotelOfferListItem = {
  id: guid(),
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/hotels/Hotel_4_Brickell.png',
  title: 'Brickell',
  description: '',
...
export const hotelOfferListItem5: HotelOfferListItem = {
  id: guid(),
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/hotels/Hotel_5_LB.png',
  title: 'Lux Brickell',
  description: '',
  address: '1300 South Miami Avenue, Miami, FL 33130',
  startingPrice: 180,
...
export const hotelOfferListItem6: HotelOfferListItem = {
  id: guid(),
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/hotels/Hotel_6_BM.png',
  title: 'Baha Mar',
  description: '',
...
export const nightLifeOfferItem: TimedOfferItem = {
  id: 'cjg8ckfiq000h3i5nhxn9rp0o',
  parentId: 'cjg8ckfik00083i5nstq6amr4',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/nightlife/Nightlife_1.png',
...
const nightLifeOfferItem1: TimedOfferItem = {
  id: 'cjg8ckfiq000g3i5nw3tzbi79',
  parentId: 'cjg8ckfik00083i5nstq6amr4',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/nightlife/Nightlife_2.png',
...
const nightLifeOfferItem2: TimedOfferItem = {
  id: 'cjg8ckfip000f3i5noyq0gk8y',
  parentId: 'cjg8ckfik00083i5nstq6amr4',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/nightlife/Nightlife_3.png',
...
const nightLifeOfferItem3: TimedOfferItem = {
  id: 'cjg8ckfip000f3i5noyq0gk8z',
  parentId: 'cjg8ckfik00083i5nstq6amr4',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/nightlife/Nightlife_4.png',
  title: 'Private Suites at Hyde Sunset Kitchen + Cocktails',
  description: 'Accommodate up to 10 guests, 4 bottles',
  startingPrice: 1200,
  type: OfferItemType.Timed
}
export const spaLifeOfferItem: TimedOfferItem = {
  id: 'cjg8ckfio000e3i5n7o5xgn6m',
  parentId: 'cjg8ckfim000a3i5n776twm0r',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/spa/SPA_1.png',
...
const spaLifeOfferItem1: TimedOfferItem = {
  id: 'cjg8ckfio000d3i5nw52a4nki',
  parentId: 'cjg8ckfim000a3i5n776twm0r',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/spa/SPA_2.png',
...
const spaLifeOfferItem2: TimedOfferItem = {
...
const spaLifeOfferItem3: TimedOfferItem = {
  id: 'cjg8ckfio000c3i5nbvoyf4d9',
  parentId: 'cjg8ckfim000a3i5n776twm0r',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/spa/SPA_4.png',
...
const spaLifeOfferItem4: TimedOfferItem = {
  id: 'cjg8ckfio000c3i5nbvoyf4d0',
  parentId: 'cjg8ckfim000a3i5n776twm0r',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/spa/SPA_5.png',
  title: 'Serenity Lift Spirits at SLS Brickell',
  description:
    'Himalayan salt scrub, Followed by a serene 60 minute Swedish massage',
  startingPrice: 340,
  type: OfferItemType.Timed
}

export const nightLifeOfferItemParent: TimedOffer = {
  id: 'cjg8ckfik00083i5nstq6amr4',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/home/SLS_2_Nightlife.png',
  title: 'Night Life',
...
export const hotelOfferItemParent: HotelOffer = {
  ...
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/home/SLS_1_Hotel.png',
  title: 'Hotels',
...
export const spaOfferItemParent: TimedOfferListItem = {
  id: 'cjg8ckfim000a3i5n776twm0r',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/home/SLS_3_Spa.png',
  title: 'Spa Treatment',
...
export const offer: AnyOffer = {
  ...
  details: '',
  uri: 'sls',
  items: [hotelOfferItemParent, nightLifeOfferItemParent, spaOfferItemParent]
}
...
export const offerPage: OfferPage = {
  ...
  backgroundImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/background.png',
  leaderboardImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/gif_SLS.gif',
  progressImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/confirmation_reward+progress.svg',
  confirmationDetailsImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo-sls/images/travel+bag.svg',
