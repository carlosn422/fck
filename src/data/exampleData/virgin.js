...
from the moonlight.`);
const addOnItemCopy1 = formatCopyWithList(`The Beach Club[Thank you for a truly amazing stay! This private 
...
<div style="flex: 1;">
  ...
  `);
const addOnItemCopy2 = formatCopyWithList(`Aquatic Club[Calm, Serene, Retro – What a way to relax and enjoy while 
  ...
  letting last night's choices melt away as you glide through the water — our pool club is a serene space for
   ultimate relaxation.`, `<div style="flex: 1;">
   <p style="color: #5a5f73;">WHAT TO BRING</p>
   <ul style="margin-top: 1em;list-style-type: disc;padding-left: 20px;">
     <li>Photo identification</li>
     <li>Camera</li>
...
const addOnItemCopy3 = formatCopyWithList(`The Manor[The service here has just been fantastic; whatever we 
...
<div style="flex: 1;">
  ...
  `);
const addOnItemCopy4 = formatCopyWithList(`The Red Room[It is not all that often that one can say that an 
...
exports.offerAddOn1 = {
    ...
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Experience1_hero.png',
...
exports.offerAddOn2 = {
    ...
    parentId: 'cjftxsxt10001ho8e495ushvq',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Experience2_hero.png',
    title: 'Aquatic Club',
...
exports.offerAddOn3 = {
    ...
    parentId: 'cjftxsxt10001ho8e495ushvq',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Experience3_hero.png',
    title: 'The Manor',
...
exports.offerAddOn4 = {
    ...
    parentId: 'cjftxsxt10001ho8e495ushvq',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Experience4_hero.png',
    title: 'The Red Room',
...
exports.addonOfferParent = {
    ...
    venue: '',
    items: [exports.offerAddOn1, exports.offerAddOn2, exports.offerAddOn3, exports.offerAddOn4],
    rewards: exports.cruseRewards
};
exports.roomItem1 = {
    id: 'ck2qrt3c1005lbmlshictyfbr',
    parentId: 'cjg8ckfin000b3i5nqvliryz6',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Choose+2_hero.png',
...
exports.roomItem2 = {
    ...
    parentId: 'cjg8ckfin000b3i5nqvliryz6',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Choose+3_hero.png',
...
exports.roomItem3 = {
    ...
    parentId: 'cjg8ckfin000b3i5nqvliryz6',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Choose+4_hero.png',
...
exports.roomItem4 = {
    ...
    parentId: 'cjg8ckfin000b3i5nqvliryz6',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Choose+5_hero.png',
...
exports.hotelOfferListItem1 = {
    id: 'guid()',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Voyages+1_hero.png',
    title: 'Mayan Sol',
    description: '5 Nights - Miami - Costa Maya - The Beach Club at Bimini - Miami',
    address: '',
    startingPrice: 1150,
    type: offerTypes_1.OfferItemType.Hotel,
    ...
    items: [exports.roomItem1, exports.roomItem2, exports.roomItem3, exports.roomItem4],
    rewards: exports.cruseRewards
};
exports.hotelOfferListItem2 = {
    id: 'guid()',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Voyages+2_hero.png',
    title: 'Dominican Daze',
    description: '5 Nights - Miami - Puerto Plata - The Beach Club at Bimini - Miami',
    address: '',
    startingPrice: 1150,
    type: offerTypes_1.OfferItemType.Hotel,
    media: ['https://fevo-fuc.s3.amazonaws.com/assets-virgin/Choose+1_hero.png'],
...
exports.hotelOfferListItem3 = {
    id: 'guid()',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Voyages+3_hero.png',
    title: 'Riviera Maya',
    description: '5 Nights - Miami - Cozumel - Playa del Carmen - The Beach Club at Bimini - Miami',
    address: '',
    startingPrice: 2350,
    type: offerTypes_1.OfferItemType.Hotel,
    media: ['https://fevo-fuc.s3.amazonaws.com/assets-virgin/Choose+1_hero.png'],
...
exports.hotelOfferListItem4 = {
    id: 'guid()',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Voyages+4_hero.png',
...
exports.hotelOfferListItem5 = {
    id: 'guid()',
    thumbnailImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Voyages+5_hero.png',
    title: 'Holidayze and Nights',
    description: '7 Nights - Miami - Puerto Plata - San Juan - The Beach Club at Bimini - Miami',
    address: '',
    startingPrice: 3950,
    type: offerTypes_1.OfferItemType.Hotel,
    media: ['https://fevo-fuc.s3.amazonaws.com/assets-virgin/Choose+1_hero.png'],
...
exports.offerPage = {
    ...
    backgroundImage: 'https://fevo-fuc.s3.amazonaws.com/assets-virgin/Background.png',
