...
export const offerItemMerch: MerchOfferItem = {
  ...
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/merch_thumb_1.png',
  title: 'Peanuts Breakfast Buffet',
  description: '',
  startingPrice: 28,
  type: OfferItemType.Merch,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/merch-hero-1.png',
...
export const offerItemMerch2: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/merch_thumb_2.png',
  title: 'Cedar Point Tee',
  description: '',
  startingPrice: 34.99,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/merch-hero-2.png',
...
export const offerItemMerch3: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/merch_thumb_3.png',
  title: 'Cedar Point Drink Bottle',
  description: '',
  startingPrice: 14.95,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/merch-hero-3.png',
...
export const offerItemMerch4: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/merch_thumb_4.png',
  title: 'Cedar Point Beanie',
  description: '',
  startingPrice: 24.95,
  type: OfferItemType.Merch,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/merch-hero-4.png',
...
export const offerAddOnMerch: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/add-on-thumb-1.png',
...
export const offerAddOnMerch2: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/add-on-thumb-2.png',
  title: 'Daily parking',
  description: 'Self-parking after 6 pm for all guests',
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/add-on-hero-2.png',
...
export const offerAddOnMerch3: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/add-on-thumb-3.png',
  title: 'Karaoke & PeanutsTM',
  description: 'Karaoke with Peanuts & friends',
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/add-on-hero-3.png',
...
export const offerAddOnMerch4: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/add-on-thumb-4.png',
  title: 'Peanuts Family Movie & Story Time with Snoopy',
  description: 'Premium Section',
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/add-on-hero-4.png',
...
export const hotelOfferItem1: HotelOfferItem = {
  ...
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel-thumb-1.png',
  title: 'King Room Sky',
  description: '',
  startingPrice: 149,
  media:
...
export const hotelOfferItem2: HotelOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvr',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel-thumb-2.png',
  title: 'Queen Room Terrace',
  description: '',
  startingPrice: 209,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel-room-hero-3.png',
...
export const hotelOfferItem3: HotelOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvr',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel-thumb-3.png',
  title: 'Queen Room City',
  description: '',
  startingPrice: 269,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel-room-hero-4.png',
...
export const hotelOfferItem4: HotelOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvr',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel-thumb-4.png',
  title: 'Bunk Room',
  description: '',
  startingPrice: 119,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel-room-hero-5.png',
...
export const hotelOfferListItem1: HotelOfferListItem = {
  id: cuid(),
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel_thumbnail_1.png',
...
export const hotelOfferListItem2: HotelOfferListItem = {
  id: cuid(),
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel_thumbnail_2.png',
  // prettier-ignore
...
export const hotelOfferListItem4: HotelOfferListItem = {
  id: cuid(),
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/hotel_thumbnail_4.png',
...
export const eventOfferItem: ManyTicketsOfferItem = {
  id: 'cjwkx9zc2000001jld3nfgymr',
  parentId: 'cjftxsxt10001ho8e495ushvq',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/02_thumbnail_1.png',
...
const eventOfferItem1: EventOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvq',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/02_thumbnail_2.png',
  title: 'Wild Card',
  description: '',
  startingPrice: 59.99,
  type: OfferItemType.Event,
  ...
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/ticket-hero-2.png'
}
const eventOfferItem2: EventOfferItem = {
  id: 'cjwkxa84p000201jlgnh52680',
  parentId: 'cjftxsxt10001ho8e495ushvq',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/02_thumbnail_3.png',
  ...
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/ticket-hero-3.png'
}
const eventOfferItem3: EventOfferItem = {
  id: 'cjwkxabnf000301jleprucyk6',
  parentId: 'cjftxsxt10001ho8e495ushvq',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/02_thumbnail_4.png',
  ...
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/ticket-hero-4.png'
}
const eventOfferItem4: EventOfferItem = {
  id: 'cjv59fk4q000301l5e7sqcaq4',
  parentId: 'cjftxsxt10001ho8e495ushvq',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/02_thumbnail_5.png',
  ...
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/ticket-hero-5.png'
}
...
export const comingSoonOfferItem1: MerchOfferItem = {
  id: 'cjwqsqs3d000a01l53ci0h0dr',
  parentId: 'cjftxsxt10001ho8e495ushvq',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/coming-soon_thumb_1.png',
  title: 'Pre-Sale Tickets',
  description:
    'Be the first to adventure before the official opening to the public',
  startingPrice: 78,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/comingSoon-hero-1.png',
  type: OfferItemType.Merch,
  htmlDescription: comingSoonItemCopy1,
  productDetails: { colors: [], sizes: [] }
}
export const comingSoonOfferItem2: MerchOfferItem = {
  id: 'cjwqsqqn9000901l57l759vtw',
  parentId: 'cjftxsxt10001ho8e495ushvq',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/coming-soon_thumb_2.png',
  title: 'Forbidden Frontier Opening Weekend',
  description: '',
  startingPrice: 79,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/comingSoon-hero-2.png',
  type: OfferItemType.Merch,
  htmlDescription: comingSoonItemCopy2,
  productDetails: { colors: [], sizes: [] }
}
export const comingSoonOfferItem3: MerchOfferItem = {
  id: 'cjwqsqneo000801l5ggckedyl',
  parentId: 'cjftxsxt10001ho8e495ushvq',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/coming-soon_thumb_3.png',
  title: 'Forbidden Frontier Festival',
  description: '',
  startingPrice: 40,
  media:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/comingSoon-hero-3.png',
  type: OfferItemType.Merch,
...
export const eventOfferItemParent: EventOfferListItem = {
  id: cuid(),
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/01_home_thumbnail_1.png',
  ...
  rewards: eventRewards,
  items: [eventOfferItem2, eventOfferItem1, eventOfferItem3, eventOfferItem]
}

export const hotelOfferItemParent: HotelOffer = {
  id: 'cjftxsxt10001ho8e495ushvr',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/01_home_thumbnail_2.png',
  title: 'Hotels',
  description: '',
  type: OfferItemType.Hotel,
  address: '',
...
export const merchOfferItemParent: MerchOfferListItem = {
  id: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/01_home_thumbnail_3.png',
...
export const comingSoonOfferItemParent: MerchOfferListItem = {
  id: 'cjftxsxt10001ho8e495ushvd',
  thumbnailImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/01_home_thumbnail_4.png',
  ...
  uri: 'coming-soon',
  items: [comingSoonOfferItem1, comingSoonOfferItem2, comingSoonOfferItem3]
}
...
export const offerPage: OfferPage = {
  ...
  backgroundImage:
    'https://fevo-fuc.s3.amazonaws.com/assets-demo-cedar-point/00_Landing_page.png',
