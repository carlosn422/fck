...
export const offerItemMerch2: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt10001ho8e495ushvw',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-nutrisystem/nutri_left+pic_2-2.png',
  title: 'Core',
  description: '',
  media:
    'https://s3.amazonaws.com/fevo-fuc/assets-nutrisystem/nutri_left+pic_2-2.png',
...
export const offerItemMerch3: MerchOfferItem = {
  ...
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-nutrisystem/nutri_left+pic_3-2.png',
...
export const offerItemMerch4: MerchOfferItem = {
  ...
  parentId: 'cjftxsxt1000bxc8e495ushvw',
  thumbnailImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-nutrisystem/nutri_left+pic_4-2.png',
...
export const offerPage: OfferPage = {
  ...
  backgroundImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-nutrisystem/Nutri_bg_1.png',
  leaderboardImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-demo/images/gif_WBG.gif',
  progressImage: '',
  confirmationDetailsImage:
    'https://s3.amazonaws.com/fevo-fuc/assets-nutrisystem/confirmation.svg',
